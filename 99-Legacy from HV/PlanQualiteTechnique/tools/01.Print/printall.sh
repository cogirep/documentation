...
exportdirectory="/Users/SWilbert/Documents/PAQP/"
...
pandoc $now.allpages.md  --reference-doc=$templatedirectory/Sixensetemplate.dotx -o $exportdirectory$now.PAQP.docx

rm $now.allpages.md
echo '----------------------------------------------------'
echo 'Processus terminé.'
echo 'Fichier créé: ' $exportdirectory$now.PAQP.docx
echo '===================================================='
